...
class SignInApt extends StatefulWidget {
  const SignInApt({Key? key}) : super(key: key);

  @override
  State<SignInApt> createState() => _SignInAptState();
}

class _SignInAptState extends State<SignInApt> {
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, 'signupapt');
              },
              child: Text(
                'Daftar',
