...
class SignUpAptPage extends StatefulWidget {
  const SignUpAptPage({Key? key}) : super(key: key);

  @override
  State<SignUpAptPage> createState() => _SignUpAptPageState();
}

class _SignUpAptPageState extends State<SignUpAptPage> {
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, 'signinapt');
              },
              child: Text(
                'Masuk',
  ...
  register() async {
    if (formKey.currentState!.validate()) {
      ...
      await authService
          .registerAptWithEmailandPassword(
              fullName, email, password, rumahSakit)
          .then((value) async {
        if (value == true) {
          ...
          nextScreenReplace(context, const SignInApt());
        } else {
